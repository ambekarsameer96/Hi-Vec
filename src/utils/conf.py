...
#Nested_ModelDimension
# _C.NESTED_MODEL_DIMENSION = 1
# Data directory
_C.DATA_DIR = "./data/"
...
# _C.CKPT_PATH = "./ckpt/models/"
_C.CKPT_PATH  = './ckpt_mod/ckpt/dainty-eon-79/'
...
_C.MODEL.ARCH = 'resnet50_mrl_cifar10'
...
_C.CORRUPTION.ID_DATASET = 'cifar10_c'
_C.CORRUPTION.OOD_DATASET = 'svhn_c'
_C.CORRUPTION.NUM_OOD_SAMPLES = 2500
...
_C.OWTTT.CE_SCALE = 1.
_C.OWTTT.DA_SCALE = 1.
_C.OWTTT.QUEUE_LENGTH = 512
_C.OWTTT.MAX_PROTOTYPES = 100

# ------------------------------- SoTTA options -------------------------- #
_C.SOTTA = CfgNode()
_C.SOTTA.THRESHOLD = 0.99
_C.SOTTA.MEMORY_SIZE = 64
...
def get_num_classes(dataset_name):
    dataset_name2num_classes = {"cifar10": 10, "cifar10_c": 10, "cifar100": 100, "cifar100_c": 100, 'cifar8_c': 8,
                                'cifar80_c': 80, "cifar8": 8, "cifar80": 80,
